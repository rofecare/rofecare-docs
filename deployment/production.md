...
server {
    ...
    server_name rofecare.example.com;

    ssl_certificate     /etc/letsencrypt/live/rofecare.example.com/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/rofecare.example.com/privkey.pem;
